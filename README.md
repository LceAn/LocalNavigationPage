...
- **快速搜索**: 内置搜索框，可用于快速查找和访问您的链接，支持多个搜索引擎无缝切换。
- **设置界面**：更多人性化设计，依旧是静态的HTML。
...
## 更新历史
- 20231004 v1.1.0
  - 引入v4.3.1_bootstrap_CSS
  - 优化昼夜遂模式切换对应图标
  - 新增底部归属信息
  - 设置
    - 优化页面布局
    - 新增显示/隐藏归属信息按钮（存在bug，刷新后无法保存状态
    - 新增显示/隐藏搜索框按钮（存在bug，刷新后无法保存状态
      - 可分别选择显示三大引擎按钮（存在bug，刷新后无法保存状态
    - 优化现有链接列表滚动
